...
export function WhatsappOnboardingHelp({ compact = false }: { compact?: boolean }) {
    ...
    return (
      <div className="rounded-2xl border border-border/60 bg-card p-4">
        <div className="flex items-start gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-bento-mint text-accent">
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-accent/20 bg-bento-mint/60 elev-1 p-5 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-start gap-3">
      ...
      <Button asChild variant="outline" size="sm" className="shrink-0 rounded-xl bg-card">
