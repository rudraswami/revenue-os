  ...
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-xl border border-border/80">
        <div className="hidden grid-cols-[minmax(0,1.4fr)_minmax(0,1.2fr)_100px_100px_72px] gap-3 border-b border-border/70 bg-[#fafbfd] px-4 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground md:grid">
          <span>Member</span>
          <span>Email</span>
          <span>Role</span>
