...
export function WhatsappTemplatePicker({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-3 rounded-2xl border border-[#dce9ff] bg-[#f8f9ff] px-4 py-4 text-sm text-muted-foreground">
    ...
    return (
      <div className="space-y-3 rounded-2xl border border-dashed border-border bg-muted/20 p-4">
        ...
        <p className="text-xs text-muted-foreground">
          {isError
            ? "Could not sync templates — enter manually or reconnect WhatsApp in Settings."
            : "No approved templates yet. Create one in WhatsApp Manager, then refresh."}
        </p>
        <button
          type="button"
