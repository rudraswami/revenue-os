...
export const TEMPLATES = {
  title: "Templates",
  description:
    "Pre-approved messages for reaching customers who haven't chatted with you yet. Use them in Campaigns.",
  newTemplate: "New template",
  refresh: "Refresh",
  refreshSuccess: "Templates updated",
  emptyTitle: "No templates yet",
  emptyDescription:
    "Create your first message and we'll send it to WhatsApp for approval. Usually takes a few hours.",
  emptyAction: "Create template",
  createTitle: "New template",
  createPickDescription: "What kind of message do you want to send?",
  customizeTitle: "Customize your message",
  createCustomizeDescription: "Edit the text, then send it to WhatsApp for approval.",
  editTitle: "Edit template",
  sendForApproval: "Send for approval",
  saveChanges: "Save changes",
  pendingNote: (n: number) =>
    `${n} waiting on WhatsApp review — usually 15 min to 24 hours.`,
  templateName: "Template ID",
  templateNamePlaceholder: "followup_offer",
  templateNameHint: "For WhatsApp only. Lowercase letters, numbers, underscores.",
  category: "Message type",
  language: "Language",
  messageBody: "Message",
  bodyHint: "Tap a variable below to insert it, or type {{1}}, {{2}} yourself.",
  startersLabel: "Start from",
  startBlank: "Write your own",
  startBlankHint: "Start from scratch with a blank message",
  backToStarters: "Back",
  showAdvanced: "Show template ID",
  hideAdvanced: "Hide template ID",
  fastApproval: "Fast approval",
  standardApproval: "1–2 days",
  useInCampaign: "Use in campaign",
  awaitingReview: "Waiting on WhatsApp approval",
