...
export const GROWVISI_WEB_URL = "https://www.growvisi.com";
export const GROWVISI_WEB_URL_APEX = "https://growvisi.com";
export const GROWVISI_API_URL = "https://api.growvisi.com";
export const GROWVISI_API_V1_URL = `${GROWVISI_API_URL}/api/v1`;
export const GROWVISI_WS_URL = "wss://api.growvisi.com";
...
export const GROWVISI_EMAIL_FROM = "Growvisi <noreply@growvisi.com>";
